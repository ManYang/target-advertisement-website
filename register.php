...
<?php 
		...
		$connect= mysql_connect("127.0.0.1","123","123") or die ("Couldn't connect to database".mysql_error());
		mysql_select_db("comp7105cept", $connect);
		...
		{
			$sql2 = "insert users values ($username, $password);";
